        ...
        <div>
            {
                data && data.map((module, index) =>
                    <>
                        <div className="transition-all duration-500 my-2 hover:bg-transprent border text-gray-600 border-gray-200 rounded-md">
                            <>

                                <div
                                    key={module?.id}

                                    className={`accordion-header    cursor-pointer transition flex space-x-5 px-2 xl:px-3 items-center h-auto ${expandedIndex === index ? "bg-transprent" : ""
                                        }`}
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between w-full   p-3 ">
                                        ...
                                        <div className='flex items-center justify-center ml-3'>
                                            <button
                                                className=" bg-transprent  text-primaryText font-bold text-sm xl:text-base rounded-lg "
