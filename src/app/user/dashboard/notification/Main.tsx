                                            ...
                                            <tr className="focus:outline-none w-full h-16 border border-gray-100 rounded grid grid-cols-8 place-content-center ">
                                                ...
                                                <td className="  text-center col-span-3 mt-3">
                                                    <div className="flex items-center pl-5">
                                                        <p className="text-base font-medium leading-none text-white-700 mr-2" style={{color:'white'}}> {item?.title}</p>
                                                ...
                                                <td className="ml-2  text-center col-span-2 ">
                                                    <button className="py-3 px-3 text-sm focus:outline-none leading-none text-primary  bg-primary/10 rounded" style={{color:'white'}}>Published  at {item?.createdAt.slice(11, 16)}</button>
                                                </td>
