    ...
    return (
        <div>
            <div className="my-2 flex justify-end sm:flex-row flex-col">
                ...
                <Link href='/user/dashboard/leads/create' className='bg-primary px-5 py-1.5 rounded-md text-white' style={{backgroundColor:'#14bfd5'}}>
                    Create Lead
                </Link>
                ...
                <div className="block relative">
                    ...
                    <input
                        ...
                        className="  sm:rounded-l-none border border-gray-300 border-b block pl-8 pr-6 py-2 w-full bg-transprent text-sm placeholder-gray-400 text-gray-700  focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none dark:bg-darkBg dark:border-darkBorder" />
                </div>
            </div>
