...
const Sidebar = ({ data, setCurrentModule }: { data: any, setCurrentModule: any }) => {
    ...
    return (
        <div className="flex flex-col py-8 pl-6 pr-2 w-80 rounded-lg bg-transprent flex-shrink-0">
            <div className="flex flex-row items-center  h-12 w-full">
                ...
                <div className="ml-2 font-bold text-2xl"                 style={{color:'white'}}
>All Chats</div>
            </div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="ml-2  ">
                                        ...
                                        <div>
                                            <span className='text-sm font-semibold text-left'                 style={{color:'white'}}
> {item?.forModule?.title.slice(0, 30)}</span>
