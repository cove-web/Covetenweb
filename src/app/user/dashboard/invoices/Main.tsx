            ...
            <div className='w-full'>
                {
                    data?.invoices.length === 0 && (
                        <div className='bg-white border-b px-4 py-5 text-sm border-gray-200  text-dimText flex items-center justify-between' style={{backgroundColor:'rgba(232, 232, 232, 0.5)'}}>
