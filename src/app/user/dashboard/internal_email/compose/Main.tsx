...
const Main = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="inline-block align-bottom bg-transprent rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden  transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6">
                                ...
                                {({ getRootProps, getInputProps }) => (
                                    <div {...getRootProps()}>
                                        <label
                                            ...
                                            className="flex flex-col items-center w-full  p-5 mx-auto mt-2 text-center bg-transprent border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl"
                                        >
                                            <svg
