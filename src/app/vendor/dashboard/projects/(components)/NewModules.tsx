                ...
                <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800 "  style={{backgroundColor:'#e8e8e880'}}>
                    ...
                    {modules?.length ?
                        (modules?.map((module: any, index: number) =>
                            ...
                            <tr key={module?.id} className={`${module?.isViewedByVendor ? 'bg-white' : 'bg-gray-200'}  dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400`}  style={{backgroundColor:'#e8e8e880'}}>
