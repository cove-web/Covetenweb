...
const Main = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className='bg-white'      style={{backgroundColor:'#e8e8e880'}}>
                <PageTextEditor setEditorState={setEditorState} editorState={editorState} />
            </div>

            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden  transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6"     style={{backgroundColor:'#e8e8e880'}}>
