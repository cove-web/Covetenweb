...
const ChatBody = ({ messages, empemail }: Props) => {
  //states
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (text) {
      ...
      try {
        await updateDoc(doc(db, "empchats", empemail), {
          messages: arrayUnion({
            id: uuidv4(),
            text,
            senderId: user?.email,
    ...
    <div className="flex flex-col flex-auto h-full px-6">
      <div className="flex flex-col flex-auto flex-shrink-0 rounded-lg bg-white h-full lg:max-h-[85vh]"      style={{backgroundColor:'#e8e8e880'}}>
        ...
        >
          ...
          <p className="font-bold">#{empemail}</p>
        </div>
                  ...
                  <div className="flex items-center justify-start flex-row-reverse">
                    ...
                    >
                      ...
                      <p className="text-[8px] text-gray-600 mt-1">
                        send by {message?.senderName === user.name ? 'you' : message?.senderName}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative flex border-none">
            ...
            <div className="absolute right-0 items-center inset-y-0 pr-5 hidden sm:flex">
              <div>
                ...
                >
                  <svg
                    className="mail-attachment-label-icon"
                    viewBox="0 0 24 24"
                    fill="none"
