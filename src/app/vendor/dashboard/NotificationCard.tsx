...
const NotificationCard = () => {
    return (
        <div className="relative p-6 flex flex-col min-w-0 break-words bg-white dark:bg-gray-800 w-full shadow-sm rounded"                     style={{ backgroundImage: ' url(https://b24-0txa1s.bitrix24.in/bitrix/templates/bitrix24/themes/light/contrast-horizon/contrast-horizon.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
