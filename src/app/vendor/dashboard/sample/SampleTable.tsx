                                    ...
                                    <div className="flex flex-row mb-1 sm:mb-0">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className=" h-full rounded-r block  w-full bg-white border text-sm pr-8 border-gray-300  py-1 px-3  leading-tight focus:outline-none  dark:bg-darkBg dark:border-darkBorder"  style={{backgroundColor:'#e8e8e880'}}>
