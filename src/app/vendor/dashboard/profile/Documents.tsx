...
const Documents = ({ data, refetch }: { data: any, refetch: any }) => {
    ...
    // render
    return (
        <div className="relative flex flex-col mt-6 justify-center bg-transprent max-w-xs py-4 px-1  shadow-sm rounded-xl sm:px-7 dark:bg-gray-900 dark:text-gray-100">
