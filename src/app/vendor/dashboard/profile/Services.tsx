...
const Services = ({ data, refetch }: { data: string[], refetch: any }) => {
    ...
    // render
    return (
        <div className="relative border h-full flex flex-col mt-6 justify-center bg-transprent max-w-xs py-4 px-1  shadow-sm rounded-xl sm:px-7 dark:bg-gray-900 dark:text-gray-100">
            {/* edit button */}
            <div>
