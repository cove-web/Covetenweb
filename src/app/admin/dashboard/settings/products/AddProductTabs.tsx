...
interface IAddProductTabsProps {
    ...
    updateProduct: any; // Updated function signature
}
...
const AddProductTabs = ({ addNewProductFn, productData, deleteProduct, addToHome,updateProduct }: IAddProductTabsProps) => {
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="w-full min-h-screen bg-white rounded-xl mt-2 py-2  -md">
                                <ProductTable productData={productData} deleteProduct={deleteProduct} addToHome={addToHome} updateProduct={updateProduct} />
                            </div>
