...
mutation Mutation($where: ProductWhere, $update: ProductUpdateInput) {
...
const Main = () => {
   ...
   const [updateProductFn, updateProductState] = useMutation(UPDATE_PRODUCT, { client })
   ...
   const updateProduct = async (id: string) => {
       ...
       if (data.updateProducts.info.nodesCreated) {
   ...
   return (
       <>
           <AddProductTabs addToHome={addToHome} productData={productData?.products} addNewProductFn={addNewProduct} deleteProduct={deleteProduct} updateProduct={updateProduct} />
