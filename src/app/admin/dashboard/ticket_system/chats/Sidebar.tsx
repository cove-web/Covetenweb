    ...
    return (
        ...
        >
            <div className="flex flex-row items-center  h-12 w-full">
                ...
                <div className="ml-2 font-bold text-2xl text-center text-desktopPrimary" style={{color:'#696cff'}}>All Tickets</div>
            </div>
                        ...
                        data && data?.map((item: any) =>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="ml-2  ">
                                        <p className='text-desktopPrimary text-md text-left' style={{color:'#696cff'}}>#{item.ticket}</p>
                                        <div>
