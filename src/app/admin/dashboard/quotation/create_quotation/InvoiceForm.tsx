                            ...
                            <div className="lg:col-span-2">
                                <form onSubmit={handleSubmit(handleCreating)} className=" md:grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div className="md:col-span-5 mb-10">
                                        <label htmlFor="full_name">Select Company<span className="text-red-500">*</span></label>
                                    ...
                                    <div className='col-span-2 '>
                                        <p >Tax<span className="text-red-500">*</span></p>
                                    ...
                                    <div className='col-span-2 '>
                                        <p >Expiry Date<span className="text-red-500">*</span></p>
                                        <input
                                            type="date"
                                            required
                                    ...
                                    <div className='col-span-full  w-full mt-3'>
                                        <p >HSN/SAC Code<span className="text-red-500">*</span></p>
                                    ...
                                    <div className='col-span-full w-full mt-3'>
                                        <p >Place Of Supply<span className="text-red-500">*</span></p>
                                    ...
                                    <div className='col-span-full w-full mt-3'>
                                        ...
                                        <div className="flex  sm:flex-row w-full ">
                                            ...
                                            <div className="block relative w-full">
                                                <select required className="    border border-gray-300 border-b block pl-8 pr-6 py-2.5 w-full bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none" id="" {...register("type")}>
