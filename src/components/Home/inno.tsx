                ...
                <div className="relative max-w-2xl mx-auto sm:text-center">
                    <div className="relative z-10">
                        ...
                        <p className="mx-auto max-w-screen-md text-center text-dimText dark:text-darkDimText">
                            You may find the majority of tests, technologies, processes, techniques, equipment, experts, and many more cutting-edge innovations
                        </p>
                    </div>
                    <div aria-hidden="true" className="absolute inset-0 my-auto max-w-xsh-32 rotate-45 bg-gradient-to-r from-[#00b1fd] to-[#71faca] blur-[90px] opacity-50 dark:opacity-20"></div>
